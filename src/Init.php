...
class Init
{
    ...
    public function scriptsAndStyles()
    {
        ...
        wp_enqueue_script('init_maps', get_stylesheet_directory_uri() . '/assets/js/maps.js', [], FEDERICO_NICOLE_VERSION, true);
        wp_enqueue_script('get_maps', '//maps.googleapis.com/maps/api/js?key=AIzaSyDQuYUx4Gv2jQPhIA5UIA31KD8_KY5wfpg&callback=initMaps', ['init_maps'], FEDERICO_NICOLE_VERSION, true);
    }
}